&Input 
IVD%TORDER = 10,  !LOBATTO QUADRATURE ORDER FOR V-SPACE 
IVD%rv = 7000,  !RADIAL EXTENT OF THE V-SPACE 
IVD%FORCEOUT = 1, !OUTPUT FORCES IN RESIDUAL YES/NO?
IVD%NTIME = 1, !NUMBER OF TIMESTEPS 
...
IVD%T1 = 7000, !INITIAL TEMP IN DOMAIN 
IVD%P1 = 0.00000000075, !INITIAL PRESSURE IN DOMAIN 
IVD%U0 = 800!INITIAL U-VEL IN DOMAIN 
IVD%V0 =  0, !INITIAL V-VEL IN DOMAIN 
IVD%INF = 1, !INFLOW BOUNDARY SWITCH ON/OFF 
IVD%CINF(1) = 7000, !INFLOW TEMP 
IVD%CINF(2) = 0.00000000075, !INFLOW PRESSURE 
IVD%CINF(3) = 800, !INFLOW U-VEL 
IVD%CINF(4) = 0,   !INFLOW V-VEL 
IVD%NVSPACEPART =  1,
IVD%W = 1.0,  !INICON(orig) INITIAL CONDITION PARAMETER 
IVD%LobattoFile = "Lobatto10.txt", !Lobatto Quadrature File 
IVD%PSpaceFile = "reentry.plt", !PSpace Mesh File 
IVD%OutFile = "FILE.OUT", !Output File 
IVD%PartitionFile = "reentry.con.npart.1", !METIS PARTITION FILE 
