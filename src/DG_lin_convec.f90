...
! 
     ...
     &        NPOIN_PP,VNPNT,VCORD,DISNF_PP,IPCOM_PP,MPI_RANK_P,CINF,rv,&
     &    IVD,R,M,&
     &                 MPI_RANK_P,MPI_SIZE_P,MPI_COMM_P,&
     &                 MPI_RANK_V,MPI_SIZE_V,MPI_COMM_V,&
     &                 VSPACE_FIRST,VSPACE_LAST) 
...
! 
     CALL OUTPUT(NNODE ,NPOIN_PP ,NPOIN,NELEM ,NELEM_PP,maxNELEM_pp,&
     &           COORD,INTMA, DISNF_PP, VNPNT,IPCOM_PP,ELGRP,NEGRP,IVD,&
     &                     MPI_RANK_P,MPI_SIZE_P,MPI_COMM_P,&
     &                     MPI_RANK_V,MPI_SIZE_V,MPI_COMM_V,&
     &                     VSPACE_FIRST,VSPACE_LAST)
       RETURN 
