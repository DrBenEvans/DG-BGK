...
!
 1001 CONTINUE
      ...
      NPGRP(IG)=NPOIN_PP            
!
! *** MPI COMMAND TO SEND NPOIN_PP,INTMA_PP AND IPCOM_PP TO PROCESSOR RANK IG !!!!!!!!!!!!!!!
!	
      TAG1=1
      SIZE1=1
      TAG2=2
      ...
      TAG3=3
      SIZE3=maxNPOIN_PP
      CALL MPI_SEND(NPOIN_PP,SIZE1,MPI_INTEGER,IG,TAG1,&
     &       MPI_COMM_P,MPI_IERR)
      CALL MPI_SEND(INTMA_PP,SIZE2,MPI_INTEGER,IG,TAG2,&
     &        MPI_COMM_P,MPI_IERR)
      CALL MPI_SEND(IPCOM_PP,SIZE3,MPI_INTEGER,IG,TAG3,&
     &          MPI_COMM_P,MPI_IERR)
!
10001 CONTINUE
