     ...
     &      RANKno,LCOMM_PP,IPCOM_PP,IBCOM_PP,ISCOM_PP,&
     &      NPGRP,NCOMM_PP,SDCOM_PP)
!
...
!
      ...
      INTEGER TAG16,SIZE16,TAG17,SIZE17,RANKno,MPI_IERR
...
!
     ...
     &         TAG5,MPI_COMM_WORLD,MPI_IERR)
        CALL MPI_SEND(BSIDO_PP,SIZE6,MPI_INTEGER,IG,& 
     &         TAG6,MPI_COMM_WORLD,MPI_IERR)
        CALL MPI_SEND(RSIDO_PP,SIZE7,MPI_REAL,IG,&
     &   TAG7,MPI_COMM_WORLD,MPI_IERR) 
...
!
     ...
     &         TAG5,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR )
          TAG6=6
          SIZE6=NBNOI*maxNBOUN_PP
         CALL MPI_RECV(BSIDO_PP,SIZE6,MPI_INTEGER,0,&
     &    TAG6,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR)
          TAG7=7
          SIZE7=NBNOR*maxNBOUN_PP
          CALL MPI_RECV(RSIDO_PP,SIZE7,MPI_REAL,0,&
     &    TAG7,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR)
          TAG8=8
          SIZE8=maxNBOUN_PP
...
!
     ...
     &       TAG9,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR)
        IF(IMMAT.EQ.1)THEN 
        TAG10=10
        SIZE10=maxNELEM_PP*NNODE
...
!
     ...
     &   TAG11,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR)
         TAG12=12
         SIZE12=maxNSIDE_PP
         TAG13=13
         SIZE13=maxNSIDE_PP
     ...
     &    TAG12,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR)
         CALL MPI_RECV(NY_PP,SIZE13,MPI_REAL,0,&
     &    TAG13,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR)
         CALL MPI_RECV(EL_PP,SIZE14,MPI_REAL,0,&
     &    TAG14,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR)
          TAG15=15
          SIZE15=8*maxNSIDE_PP
          TAG16=16
          SIZE16=maxNSIDE_PP
    ...
    &     TAG15,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR)
    CALL MPI_RECV(ISCOM_PP,SIZE16,MPI_INTEGER,0,&
    &     TAG16,MPI_COMM_WORLD,MPI_STATUS,MPI_IERR)
...
!
      CALL EDGCOM(NGRPS,RANKno,NCOMM_PP,NSIDE_PP,SDCOM_PP,ISIDE_PP,&
     &               LCOMM_PP,ISCOM_PP)
!
! *** FORMAT STATEMENTS
!
