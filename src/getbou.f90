MODULE GETBOU_MODULE
CONTAINS
  SUBROUTINE GETBOU(NBOUN, NBNOR, NELEM_PP, &
                    BSIDO, IEL, RSIDO, &
                    IP1, RHS, IN1, &
                    IN2, UX, UY, &
                    ALPHA, ETA, VNPNT, &
...
!
    ...
    REAL SPEED, Rf1, Rf2, Mf, Mw, RT, THETA
!
