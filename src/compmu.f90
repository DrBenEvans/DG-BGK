MODULE COMPMU_MODULE
CONTAINS
  SUBROUTINE COMPMU(rv, VNPNT, NNODE, &
                    DISNF_PP, VCORD, NELEM_PP, &
                    MU_PP, DISND_PP, DISUX_PP, &
                    DISUY_PP, SUMWEIGHT, d, &
...
!
    ...
    INTEGER VNPNT, NNODE, NELEM_PP, IE, IV, IN
!
    ...
    REAL CR
    REAL CX0, CY0, CDASH, SIGT, VCORD(3, VNPNT)
    REAL DISND_PP(NNODE, NELEM_PP), ND
