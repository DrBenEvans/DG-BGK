...
!
      ...
      INTEGER NEGRP(MPI_SIZE_P-1),ISIDE(8,NSIDE),BSIDO(NBNOI,NBOUN) 
      INTEGER GCOMM(MPI_SIZE_P-1,MPI_SIZE_P-1) 
      ...
      INTEGER ISCOM_PP(maxNSIDE_PP),NPGRP(MPI_SIZE_P-1) 
