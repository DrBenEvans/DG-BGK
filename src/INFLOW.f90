  SUBROUTINE INFLOW(IV,UX,UY,NNODE,VNPNT,NELEM,NPOIN,INTMA,&
...
!
      IMPLICIT NONE 
! 
      INTEGER IV,NNODE,VNPNT,NELEM,NPOIN,NBOUN,NBNOI,IP1,IP2,TEST,IPT
      ...
      REAL CINF(4),DISNF(NNODE,VNPNT,NELEM),PS(NPOIN)
!
