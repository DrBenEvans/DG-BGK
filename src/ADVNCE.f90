...
SUBROUTINE ADVNCE(NNODE,NGEOM,NBNOI,&
  ...
  &PS_PP,TEMP_PP,ALPHA,&
  &CINF,LCOMM_PP,GCOMM,&
  &IPCOM_PP,ISCOM_PP,NCOMM_PP,&
  &maxNELEM_PP,RORDER,TORDER,&
  &maxNPOIN_PP,SDCOM_PP,IVD,&
  &FORCEOUT,d,RGas,&
...
!
      ...
      INTEGER LCOMM_PP(NSIDE_PP),maxNPOIN_PP 
...
! ***     FILL DELUN(NAMAT=1,NPOIN) WITH THE VALUE SET IN C00 
     ...
     &       VSPACE_FIRST,VSPACE_LAST,&
     &       SENDRECV_TOT_LENGTH_MAX,&
     &       SENDRECV_START_OFFSETS, &
     &       SEND_EDGE_DATA,RECV_EDGE_DATA,&
     &       SEND_EDGE_DATA_IDX,RECV_EDGE_DATA_IDX)
