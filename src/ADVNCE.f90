...
!
        ...
        MPI_ALLREDUCE(DTEb,DTE,1,MPI_REAL,MPI_MIN,&
     &                  MPI_COMM_P,MPI_IERR)
...
! 
 7000 CONTINUE
      ...
      CALL GETRES(VNPNT,RESIDUAL,RESIDUAL_PP,MPI_RANK_P,NPROC,&
...
! 
      IF(MPI_RANK_P.EQ.0)THEN
        ...
        MPI_REDUCE(SUMRES,SUMRESG,1,MPI_REAL,MPI_MAX,0,MPI_COMM_V)
        SUMRE=SUMRESG
