...
! 
      ...
      REAL UX, UY, CSAFM,ALPHA,SPEED,C0,DTE,DTEc,DTEb,DTEbnew
...
! 
        DO 7000 IV=VSPACE_FIRST,VSPACE_LAST
          WRITE(*,"(A3,5I5)")"MPI",MPI_RANK_P,MPI_RANK_V,IV,&
     &                     VSPACE_FIRST,VSPACE_LAST
! 
! ***     SYNCHRONISE 
! 
...
! 
 7000   CONTINUE
        ...
        WRITE(*,"(A3,2I5,A15)")"MPI",MPI_RANK_P,MPI_RANK_V,"HERE"
...
! ***     CONSTRUCT GLOBAL MACRO VECTORS
 ...
 3011       CONTINUE
          ENDIF
        ENDIF
        WRITE(*,"(A3,2I5,A15)")"MPI",MPI_RANK_P,MPI_RANK_V,"HERE3"
! 
...
! 
        CALL MPI_BARRIER(MPI_COMM_WORLD,MPI_IERR) 
        WRITE(*,"(A3,2I5,A15)")"MPI",MPI_RANK_P,MPI_RANK_V,"HERE4"
! 
