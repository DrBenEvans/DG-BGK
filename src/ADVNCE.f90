...
!
     ...
     &                MPI_COMM_P,MPI_IERR)
        WRITE(*,*)"HERE5"
        IF(MPI_RANK_P.EQ.1)THEN
          CALL MPI_SEND(DTE,1,MPI_REAL,0,0,MPI_COMM_P,MPI_IERR)
        ENDIF
!
...
!
        ...
        IF((MPI_RANK_P.EQ.0)) THEN
          CALL MPI_RECV(DTEb,1,MPI_REAL,1,0,MPI_COMM_P,MPI_STATUS,&
     &              MPI_IERR)
          DTETEST(1)=DTEb
          DTETEST(2)=DTEc
          DTET=MINVAL(DTETEST)
