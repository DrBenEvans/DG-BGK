...
! 
      ...
      INTEGER IPCOM_PP(NPOIN_PP),RANK,MPI_IERR,IPT,IPCOMloc(maxNPOIN_PP) 
...
!	 
      DO 1000 IG=1,NGRPS
       IF(RANK.EQ.IG)THEN 
       CALL MPI_SEND(NPOIN_PP,1,MPI_INTEGER,0,1,MPI_COMM_WORLD,MPI_IERR) 
       CALL MPI_SEND(IPCOM_PP,NPOIN_PP,MPI_INTEGER,0,2,MPI_COMM_WORLD,& 
     &            MPI_IERR) 
            CALL MPI_SEND(ND_PP,NPOIN_PP,MPI_REAL,0,3,MPI_COMM_WORLD,& 
     &            MPI_IERR) 
            CALL MPI_SEND(RHO_PP,NPOIN_PP,MPI_REAL,0,4,MPI_COMM_WORLD,& 
     &                   MPI_IERR) 
            CALL MPI_SEND(UVEL_PP,NPOIN_PP,MPI_REAL,0,5,MPI_COMM_WORLD,& 
     &                   MPI_IERR) 
            CALL MPI_SEND(VVEL_PP,NPOIN_PP,MPI_REAL,0,6,MPI_COMM_WORLD,& 
     &                   MPI_IERR) 
            CALL MPI_SEND(PS_PP,NPOIN_PP,MPI_REAL,0,7,MPI_COMM_WORLD,& 
     &                   MPI_IERR) 
            CALL MPI_SEND(TEMP_PP,NPOIN_PP,MPI_REAL,0,8,MPI_COMM_WORLD,& 
     &                   MPI_IERR) 
        ENDIF 
! 
        IF(RANK.EQ.0)THEN 
           
          CALL MPI_RECV(NPOIN_PP,1,MPI_INTEGER,IG,1,MPI_COMM_WORLD,& 
     &         MPI_STATUS,MPI_IERR) 
! 
